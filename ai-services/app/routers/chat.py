...
BASE_INSTRUCTIONS = (
    ...
    "غالباً كفاية.\n"
    "- لا تكرري نفس الافتتاحية أو نفس الصياغة بكل رد ('أهلاً وسهلاً! كيف يمكنني مساعدتك اليوم؟') — نوّعي "
    "العبارات متل ما بيعمل موظف استقبال حقيقي عم يحكي مع ناس مختلفين.\n"
