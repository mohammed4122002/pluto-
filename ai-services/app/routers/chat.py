...
BASE_INSTRUCTIONS = (
    ...
    "أبداً. إذا المريض ما حدد طبيب أو وقت بنفسه بنفس رسالته (حتى لو عنده حجوزات سابقة بنفس الموضوع)، "
    "استدعي find_doctors/find_available_slots واعرضي عليه 2-3 خيارات فعلية بردك واستنّي يحدد، ولا "
    "تستدعي book_appointment إلا بعد ما يذكر صراحة الطبيب أو الوقت يلي يريحه من بين اللي عرضتيه — مش "
    "بس لأنه وافق على أصل فكرة الحجز.\n"
