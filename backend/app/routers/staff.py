...
def list_staff(
    ...
    return _attach_branch_ids(db, staff)
...
def create_staff(
    ...
    data = payload.model_dump(exclude={"branch_ids"})
    ...
    return _attach_branch_ids(db, [created])[0]
...
def update_staff(
    ...
    return _attach_branch_ids(db, [updated])[0]
