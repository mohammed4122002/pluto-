  ...
  return (
    <div className="page">
      ...
      <div className="page-header">
        <div>
          <p className="page-header-title">إعدادات الذكاء الاصطناعي</p>
          <p className="page-header-subtitle">
            مفاتيح مزوّدي الذكاء الاصطناعي المستخدمة بالرد الآلي على المرضى. اتركي الحقل فاضي وبس احفظي
            عشان يضل المفتاح الحالي كما هو. Gemini بيُستخدم فقط كبديل احتياطي تلقائي لما OpenAI يفشل (رصيد
            منتهي، انقطاع مؤقت...) — ما إله علاقة بالرد نفسه إذا OpenAI شغال طبيعي.
          </p>
        </div>
      </div>
